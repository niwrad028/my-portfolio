    ...
    >
      <div className="flex items-center justify-between">
        ...
        <div
          ...
          className={`z-[999]  ${open ? "text-gray-900" : "text-cyan-600"
      ...
      px-7 py-2 font-medium bg-cyan-600 top-0 ${open ? "right-0" : "right-[-100%]"
            }`}
        >
          <ul className="flex flex-col justify-center h-full gap-10 py-2 text-lg font-extrabold">
            {menuLinks?.map((menu, i) => (
              <li
